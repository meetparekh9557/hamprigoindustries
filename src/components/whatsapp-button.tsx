...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition-transform hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
      style={{ backgroundColor: "#25D366" }}
    >
      {/* WhatsApp glyph. Kept as the official mark rather than a generic
          chat bubble, because it is recognised without a label. */}
      <svg
        viewBox="0 0 24 24"
        className="h-7 w-7"
        fill="currentColor"
