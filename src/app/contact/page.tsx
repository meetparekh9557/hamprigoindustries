          ...
          <div className="grid gap-14 lg:grid-cols-[1.4fr_1fr]">
            ...
            <div className="lg:border-l lg:border-line lg:pl-12">
              ...
              {/* The two actions first, then the details themselves. A
                  buyer wants to press one; a buyer saving you to their
                  phone book wants to read the other. */}
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-sm px-5 py-3 text-sm font-semibold tracking-wide text-white transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
